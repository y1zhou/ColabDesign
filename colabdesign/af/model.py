...
class mk_af_model(design_model, _af_inputs, _af_loss, _af_prep, _af_design, _af_utils):
    available_protocols = ["fixbb", "hallucination", "binder", "partial", "nanobody"]
    ...
    def __init__(
        ...
        **kwargs,
        ...
        assert protocol in self.available_protocols
        ...
        #####################################
        idx = self.available_protocols.index(self.protocol)
        self.prep_inputs = (
            self._prep_fixbb,
